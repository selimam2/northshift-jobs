...
- [ ] **Cancel subscription** — "Cancel plan" button in dashboard billing section → Stripe portal (portal already supports cancellation, just needs a clear entry point and confirmation copy).
